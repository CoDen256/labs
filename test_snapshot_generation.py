...
class Test(TestCase):
    ...
    def test_create_system_snapshot_windows(self):
        ...
        group = "0"
        expected = [
            FileSnapshot(resolve("./test/generate/full/file-1.txt"), user, group, "666", dt(2022, 12, 16, 18, 47, 12),
                         "4462256a6ee3a6461a935e4cf02b8798", 287),
            FileSnapshot(resolve("./test/generate/full/file-2.txt"), user, group, "666", dt(2022, 12, 16, 18, 47, 15),
                         "0cc175b9c0f1b6a831c399e269772661", 1),
            FileSnapshot(resolve("./test/generate/full/sub/file-4.txt"), user, group, "666",
                         dt(2022, 12, 16, 18, 47, 23), "8bc2398146fb71fcdc2863d05d29433f", 1904),
            FileSnapshot(resolve("./test/generate/full/sub/sub-2/file-5.txt"), user, group, "666",
                         dt(2022, 12, 16, 18, 47, 27), "1a6f8abe44f6b9c5a7c2435c43749dea", 17),
    ...
    def test_create_system_snapshot_linux(self):
        ...
        mode = "777"
        expected = [
            FileSnapshot(resolve("./test/generate/full/file-1.txt"), user, group, mode, dt(2022, 12, 16, 18, 47, 12),
                         "4462256a6ee3a6461a935e4cf02b8798", 287),
            FileSnapshot(resolve("./test/generate/full/file-2.txt"), user, group, "%s" % mode,
                         dt(2022, 12, 16, 18, 47, 15), "0cc175b9c0f1b6a831c399e269772661", 1),
